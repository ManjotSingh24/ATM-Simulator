...
public class Withdrawl extends JFrame implements ActionListener{
    ...
    Withdrawl(String pin){
        ...
        Image i2 = i1.getImage().getScaledInstance(1000, 768, Image.SCALE_DEFAULT);
...
//                    withdraw=0-withdraw;
                    c1.s.executeUpdate("insert into bank(pin,date,type,amount) values('"+pin+"', '"+date+"', 'Withdrawl', '"+withdraw+"')");
